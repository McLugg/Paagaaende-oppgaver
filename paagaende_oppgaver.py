...
# --- Motivasjonsmeldinger ved delprosenter ---
MOTIVATION = {
...
mode = st.radio("Velg overraskelse som vises ved fullføring:", ["GIF", "Image", "CSS"], index=["GIF","Image","CSS"].index(st.session_state.surprise_mode))
